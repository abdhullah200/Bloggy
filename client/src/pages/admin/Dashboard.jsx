  ...
  return (
    <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
      <div className='flex flex-wrap gap-5'>
        {/* Blogs Card */}
        <div className='flex items-center gap-4 bg-white p-4 min-w-80 rounded shadow cursor-pointer hover:scale-105 transition-all'>
      ...
      <div>
        <div className='flex items-center gap-3 m-4 mt-6 text-gray-600'>
          <img src={assets.dashboard_icon_4} alt="Dashboard Illustration" />
          <p>Latest Blog</p>
        </div>
