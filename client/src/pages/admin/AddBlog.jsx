    ...
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button type='button' onClick={generateContent} className='absolute bottom-1 right-2 text-white bg-black/70 px-4 py-1.5 rounded hover:underline cursor-pointer'>Generate with AI</button>
        ...
        <div className='flex gap-2 mt-4'>
          <p>Publish Now</p>
          <input type='checkbox' checked={isPublic} className='scale-125 cursor-pointer' onChange={e=> setIsPublic(e.target.checked)}/>
        </div>
